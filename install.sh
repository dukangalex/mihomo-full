...

{
  ...
  printf "AIRPORT_SUB_URL=%q\n" "$AIRPORT_SUB_URL"
  printf "FIXED_FULL_CONFIG_PATH=%q\n" "$FULL_PATH"
  printf "FIXED_EXIT_NODES_PATH=%q\n" "$NODES_PATH"
  printf "DOMAIN=%q\n" "$DOMAIN"
  printf "V2RAY_AGENT_CLASHMETA_DIR=%q\n" "$V2RAY_DIR"
  printf "OUTPUT_DIR=%q\n" "$OUTPUT_DIR"
...
curl --fail --silent --show-error --location --proto "=https" --tlsv1.2 -o "${INSTALL_DIR}/generate.sh" \
  "https://raw.githubusercontent.com/dukangalex/mihomo-full/71acfd95cbfdb5acad9eff129b5855a1073d278f/generate.sh" || true
...
# 安装小白管理入口
curl --fail --silent --show-error --location --proto "=https" --tlsv1.2 -o "$INSTALL_DIR/manage.sh" "https://raw.githubusercontent.com/dukangalex/mihomo-full/69c1a38fe63530dcf38fdfa5ab2d861fb44ab556/manage.sh" || warn "无法下载 manage.sh"
