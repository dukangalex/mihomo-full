...
# 在安装开始时解析 main 的单一提交快照；所有仓库文件均从同一个 commit 下载，禁止版本混用。
...
echo; info "代码快照 : $REPO_COMMIT"; info "机场订阅 : $AIRPORT_SUB_URL"; info "域名     : $DOMAIN"; info "节点目录 : $V2RAY_DIR"; info "完整订阅路径 : $FULL_PATH"; info "落地节点路径 : $NODES_PATH"; echo
