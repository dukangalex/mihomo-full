...
curl --fail --silent --show-error --location --proto "=https" --tlsv1.2 -o "${INSTALL_DIR}/generate.sh" \
  "https://raw.githubusercontent.com/dukangalex/mihomo-full/2ebe9de092442add4236331affce4ad3085d7615/generate.sh" || true
...
if [[ ! -f "${INSTALL_DIR}/template.yaml" ]]; then
  ...
  curl --fail --silent --show-error --location --proto "=https" --tlsv1.2 -o "${INSTALL_DIR}/template.yaml" \
    "https://raw.githubusercontent.com/dukangalex/mihomo-full/2ebe9de092442add4236331affce4ad3085d7615/template.yaml" || \
