...
# 核心文件均固定到本次已审核版本，避免安装时随 main 漂移
curl --fail --silent --show-error --location --proto "=https" --tlsv1.2 -o "${INSTALL_DIR}/generate.sh" "https://raw.githubusercontent.com/dukangalex/mihomo-full/03b7879a2b0836431d1f623fcd1e46f08443977b/generate.sh" || err "无法下载已审核 generate.sh"
