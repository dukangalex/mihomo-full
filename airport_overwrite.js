...
function main(config) {
  ...
  config["proxy-groups"] = [selectGroup, autoGroup, lbGroup, adBlockGroup, claudeGroup, aiGroup, mediaGroup, youtubeGroup, googleGroup, telegramGroup, microsoftGroup, appleGroup, steamGroup, tiktokGroup, twitterGroup, spotifyGroup, globalServiceGroup, fallbackGroup, remoteToolGroup].concat(regionGroups);
